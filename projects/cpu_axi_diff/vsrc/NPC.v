...
MuxKeyWithDefault #(4,2,64) forward_c_mux (operation_a_forward,Forward_c,reg1,{
		2'b00,reg1,
		2'b10,reg_write_value_mem,
		2'b01,reg_write_value_wb,
		2'b11,sext_value_ex
	});
MuxKeyWithDefault #(4,2,64) forward_d_mux (operation_b_forward,Forward_d,reg2,{
		2'b00,reg2,
		2'b10,reg_write_value_mem,
		2'b01,reg_write_value_wb,
		2'b11,sext_value_ex
...
wire branch_en;
MuxKeyWithDefault #(6,3,1) branch_test (branch_en,branch_type,0,{
...
assign IF_Flush = (pipeline_stall) ? 0 :((branch_en||npc_op) ? 1 : 0);


wire [63:0]pc_branch_addr = pc_id + imm;
assign npc = branch_en ? pc_branch_addr :
