...
module ALU(
	...
	MuxKeyWithDefault #(3,2,64) forward_a_mux (reg1_forwarda,Forward_a,reg1,{
		2'b00,reg1,
		2'b10,sext_value_mem,
		2'b01,reg_write_value_wb	
		});
	MuxKeyWithDefault #(3,2,64) forward_b_mux (reg2_forwardb,Forward_b,reg2,{
		2'b00,reg2,
		2'b10,sext_value_mem,
		2'b01,reg_write_value_wb	
		});
	...
	MuxKeyWithDefault #(18,5,64) adder (value,alu_op,64'hfedcba9876543210,{
		`ADD,a+b,
		`SUB,a+(~b)+64'b1,
