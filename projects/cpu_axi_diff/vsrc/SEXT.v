...
MuxKeyWithDefault #(5,3,64) sext_imm (imm,optype,64'hffff0000ffff0000,{
...
MuxKeyWithDefault #(7,4,64) sext_mem_read_value (sext_read_mem_value,mem_ctrl,read_mem_value,{
		`MEM_H,
...
MuxKeyWithDefault #(2,4,64) sext_value0 (sext_value,value_width_ctrl,value,{
		`VALUE_N,value,
