...
wire		inst_skip_3	= (inst_wb == 32'h7b) | m_time_interrupt | if_clint_wb | (csr_wb == 12'hb00) ; 
...
*/
assign io_char_valid_o	= !axi_stall_i && (inst_wb == 32'h7b);
assign io_char_o		= reg10[7:0];
