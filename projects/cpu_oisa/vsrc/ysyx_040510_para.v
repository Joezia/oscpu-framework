...
//OISA_TYPE
`define	OISA_ARI_R		4'b1000
`define OISA_ARI_I		4'b0001
`define OISA_UNSEAL		4'b0010
`define OISA_SEAL		4'b0011
`define OISA_CMOV		4'b0100
`define OISA_BRANCH		4'b0101
`define OISA_JALR		4'b0110
`define OISA_JAL		4'b0111
