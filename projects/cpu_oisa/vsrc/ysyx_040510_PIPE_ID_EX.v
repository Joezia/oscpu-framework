module ysyx_040510_PIPE_ID_EX(
	...
	input		if_inst_aes64ds_id,
	input		if_inst_aes64dsm_id,
	input		if_inst_aes64es_id,
	input		if_inst_aes64esm_id,
	input		if_inst_aes64im_id,
	input		if_inst_aes64ks1i_id,
	input		if_inst_aes64ks2_id,
	input [3:0]	ks1i_rnum_id,
	input		if_cmov_id,
	...
	output reg	if_inst_aes64ds_ex,
	output reg	if_inst_aes64dsm_ex,
	output reg	if_inst_aes64es_ex,
	output reg	if_inst_aes64esm_ex,
	output reg	if_inst_aes64im_ex,
	output reg	if_inst_aes64ks1i_ex,
	output reg	if_inst_aes64ks2_ex,
	output reg	[3:0]ks1i_rnum_ex,
	output reg	if_cmov_ex,
...
always @(posedge clk)begin
	if(!rst) begin
		...
		wen_ex				<= 0; 
		write_mem_en_ex		<= 0; 
		if_inst_aes64ks1i_ex<= 0;
		if_inst_aes64ks2_ex	<= 0;
		if_cmov_ex			<= 0;
	end
		...
		if_inst_aes64ds_ex	<= if_inst_aes64ds_id;
		if_inst_aes64dsm_ex	<= if_inst_aes64dsm_id;
		if_inst_aes64es_ex	<= if_inst_aes64es_id;
		if_inst_aes64esm_ex	<= if_inst_aes64esm_id;
		if_inst_aes64im_ex	<= if_inst_aes64im_id;
		if_inst_aes64ks1i_ex<= if_inst_aes64ks1i_id;
		if_inst_aes64ks2_ex	<= if_inst_aes64ks2_id;
		ks1i_rnum_ex		<= ks1i_rnum_id;
